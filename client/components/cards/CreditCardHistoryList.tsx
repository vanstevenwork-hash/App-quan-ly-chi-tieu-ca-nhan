        ...
        <>
            <div className="flex items-center justify-between mb-2.5">
                <h3 className="text-base font-bold text-slate-800 dark:text-slate-100 flex items-center gap-2">
                    <ActionIcon type="history" size={16} tile={false} color="#6C63FF" />
                    Lịch sử giao dịch
                </h3>
                    ...
                    <div className="p-2 border-t border-gray-50 dark:border-slate-700/50">
                        <button
                            ...
                            {historyExpanded ? (
                                ...
                                <><ActionIcon type="chevronDown" size={14} tile={false} color="currentColor" /> Xem thêm {transactions.length - 5} giao dịch</>
                            )}
                        </button>
                    </div>
                )}
