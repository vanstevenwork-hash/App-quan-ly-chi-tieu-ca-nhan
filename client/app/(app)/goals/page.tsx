            ...
            <div className="relative z-10">
                ...
                <header className="pt-14 px-5 pb-4 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <h1 className="text-2xl font-bold text-slate-900 leading-tight">Mục tiêu 🎯</h1>
                    </div>
                </header>
                ...
                <div className="px-5 mt-6">
                    <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm flex flex-col items-center text-center">
                        ...
                        <h2 className="text-xl font-bold text-slate-800 mb-2">Tính năng sắp ra mắt</h2>
                        ...
                        <div className="w-full space-y-3">
                            {[
                                ...
                                <div key={goal.title}
                                    className="flex items-center gap-3 p-3 rounded-2xl bg-gray-50 border border-gray-100 opacity-60">
                                    <span className="text-xl">{goal.icon}</span>
                                    <div className="flex-1 text-left">
                                        <p className="font-semibold text-sm text-slate-700">{goal.title}</p>
