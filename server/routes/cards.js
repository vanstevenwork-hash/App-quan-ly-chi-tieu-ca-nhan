...
const { getAll, create, update, remove, setDefault, getSavingsSummary, updateBalance, payCard, renewSavings } = require('../controllers/cardController');
...
router.post('/:id/renew-savings', renewSavings);
